...
import { Copy, Download, Edit3, MoreVertical, Share2, Trash2 } from 'lucide-react';
...
export function ResumeCard({ resume, onDuplicate, onDelete, onShare }: ResumeCardProps) {
          ...
          <Menu as="div" className="relative">
            ...
            <MenuItems className="absolute right-0 z-20 mt-2 w-44 border border-[var(--border)] bg-[var(--surface)] p-1 shadow-panel">
              ...
              <MenuItem>
                ...
                >
                  <Share2 size={15} aria-hidden /> 生成只读分享
                </button>
              </MenuItem>
              <MenuItem>
                <button
